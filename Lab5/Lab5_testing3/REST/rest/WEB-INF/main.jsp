...
// xhr.open("POST", "http://localhost:8080/app1/Enter", true);
...
function save() {
	fetch('/rest/api/showArray', {method: 'POST'}).
   then(function(response) {
	   return response.json();
   })
   .then(function(data) {
	...
	// xhrreq.open("POST", "http://localhost:8080/app1/Enter", true);

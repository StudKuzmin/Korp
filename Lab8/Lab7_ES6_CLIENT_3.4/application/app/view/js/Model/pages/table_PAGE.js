const table_PAGE = 
			...
			"<html>"+
				"<div class='centerNames'>"+
					...
					"<input id='addStr' type='button' value='ADD' >"+
					"<input id='deleteStr' type='button' value='DELETE' >"+
					"<p><input id='save' type='button' value='save' style='height:30px; width:100px'><p>"+
				"</div>"+
